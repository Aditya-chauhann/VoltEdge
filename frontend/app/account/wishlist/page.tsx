    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {items.length === 0 ? (
        <div className="glass-card p-16 text-center">
          ...
          <p className="font-display font-bold text-gray-900 dark:text-white text-xl mb-2">Your wishlist is empty</p>
          <p className="text-gray-600 dark:text-gray-400 mb-6">Save your favourite gadgets here!</p>
