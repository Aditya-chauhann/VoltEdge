...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    ...
    fetchCart();
  }, [isLoggedIn, _hasHydrated, router, fetchCart]);
  ...
  const handlePlaceOrder = async () => {
    ...
    if (total < minimumOrderAmount) { toast.error(`Minimum order value for wholesale is ${formatPrice(minimumOrderAmount)}`); return; }
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex items-center gap-2 mb-8">
        ...
        <h1 className="font-display font-bold text-2xl text-gray-900 dark:text-white">Secure Checkout</h1>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {step === 'payment' && (
            ...
            >
              <h2 className="font-display font-semibold text-lg text-gray-900 dark:text-white flex items-center gap-2 mb-5">
              ...
              {/* Coupon */}
              <div className="mt-5">
                <label className="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase mb-2 block">Have a Coupon?</label>
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    <Tag size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-600 dark:text-gray-400" />
                    <input
                      type="text"
                      value={couponCode}
              ...
              {total < minimumOrderAmount ? (
                <div className="mt-4 p-3 bg-warning/10 rounded-xl flex gap-3 text-warning-700">
                  <AlertCircle className="shrink-0" />
                  <p className="text-sm font-medium">
                    Minimum order value for wholesale is {formatPrice(minimumOrderAmount)}. 
                    Add {formatPrice(minimumOrderAmount - total)} more to proceed.
                  </p>
                </div>
              ) : (
                <button
        ...
        <div className="glass-card p-6 h-fit sticky top-20">
          <h3 className="font-display font-semibold text-gray-900 dark:text-white mb-5">Order Summary</h3>
