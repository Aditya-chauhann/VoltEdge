            ...
            <form onSubmit={handleSearchSubmit} className="w-full">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-base-50 border border-primary-400/20 rounded-xl pl-9 pr-4 py-2
            ...
            {isLoggedIn ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-1.5 p-2 rounded-xl text-gray-300
                      ...
                      <div className="py-1">
                        <Link href="/account/orders"   onClick={() => setUserMenuOpen(false)}
                          className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-300
                                     hover:text-white hover:bg-primary-400/10 transition-colors">
                        ...
                        {user?.role === 'admin' && (
                          <Link href="/admin" onClick={() => setUserMenuOpen(false)}
                            className="flex items-center gap-3 px-4 py-2.5 text-sm text-primary-400
                                       hover:bg-primary-400/10 transition-colors">
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="lg:hidden border-t border-primary-400/10 bg-base-50/95 backdrop-blur-md"
          >
            {/* Mobile search */}
