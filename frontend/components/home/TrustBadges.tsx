...
import { Shield, Zap, Package, Headphones, Lock, Star } from 'lucide-react';
...
const badges = [
  ...
  { icon: Package,     label: 'Wholesale Pricing',  sub: 'Best bulk discounts', color: 'text-cyan-400' },
...
export default function TrustBadges() {
  return (
    <section className="py-10 border-y border-primary-400/10 bg-indigo-50/30 dark:bg-base-50/50">
